...
export function Footer() {
    return (
        <footer className="relative z-10 mt-auto flex w-full flex-col items-center justify-between gap-4 border-t border-[var(--text-primary)]/10 bg-[var(--background)]/80 px-8 py-5 text-[14px] font-medium text-[var(--text-secondary)] backdrop-blur-md sm:flex-row">
            <div>
